...
[ApiController]
public abstract class ModelControllerBase<TEntity, TModel, TManager> 
    : ControllerBase, IModelControllerBase<TModel>
    where TEntity : class, IKeyed, new()
    where TModel : class, IKeyed, new()
    where TManager : IManagerBase<TEntity, TModel>
{
    ...
    protected ModelControllerBase(TManager manager)
    {
        Manager = manager;
    }
