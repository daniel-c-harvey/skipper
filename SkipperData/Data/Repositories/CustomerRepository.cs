...
public class CustomerRepository<TCustomerEntity> : RepositoryBase<SkipperContext, TCustomerEntity>, ICustomerRepository<TCustomerEntity>
    where TCustomerEntity : CustomerEntity
{
    ...
    #region ICrudRepository<TCustomerEntity> Implementation

    public virtual async Task<TCustomerEntity?> GetByIdAsync(long id)
    {
        return await Context.Customers
            .OfType<TCustomerEntity>()
            .FirstOrDefaultAsync(c => c.Id == id && !c.IsDeleted);
    }

    public virtual async Task<IEnumerable<TCustomerEntity>> GetAllAsync()
    {
        return await Context.Customers
            .OfType<TCustomerEntity>()
            .Where(c => !c.IsDeleted)
    ...
    public virtual async Task<IEnumerable<TCustomerEntity>> FindAsync(Expression<Func<TCustomerEntity, bool>> predicate)
    {
        return await Context.Customers
            .OfType<TCustomerEntity>()
            .Where(c => !c.IsDeleted)
    ...
    public virtual async Task<TCustomerEntity> AddAsync(TCustomerEntity entity)
    {
        ...
        return (TCustomerEntity)result.Entity;
    }

    public virtual async Task UpdateAsync(TCustomerEntity entity)
    {
        entity.UpdatedAt = DateTime.UtcNow;
    ...
    public virtual async Task<int> GetPageCountAsync(Expression<Func<TCustomerEntity, bool>> predicate, PagingParameters<TCustomerEntity> pagingParameters)
    {
    ...
    public virtual async Task<PagedResult<TCustomerEntity>> GetPagedAsync(PagingParameters<TCustomerEntity> pagingParameters)
    {
        var query = Context.Customers
            .OfType<TCustomerEntity>()
            .Where(c => !c.IsDeleted);
    ...
    public virtual async Task<PagedResult<TCustomerEntity>> GetPagedAsync(Expression<Func<TCustomerEntity, bool>> predicate, PagingParameters<TCustomerEntity> pagingParameters)
    {
        var query = Context.Customers
            .OfType<TCustomerEntity>()
            .Where(c => !c.IsDeleted);
    ...
    public virtual async Task<IEnumerable<TCustomerEntity>> GetActiveCustomersAsync()
    {
        return await Context.Customers
            .OfType<TCustomerEntity>()
            .Where(c => !c.IsDeleted)
