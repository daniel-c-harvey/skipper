...
namespace Skipper.Data.Migrations
{
    ...
    [Migration("20250611034037_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.RentalAgreement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.Slip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.SlipClassification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.Vessel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.RentalAgreement", b =>
                {
                    b.HasOne("Skipper.Domain.Entities.Slip", "Slip")
                        .WithMany()
                        .HasForeignKey("SlipId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Skipper.Domain.Entities.Vessel", "Vessel")
                        .WithMany()
            ...
            modelBuilder.Entity("Skipper.Domain.Entities.Slip", b =>
                {
                    b.HasOne("Skipper.Domain.Entities.SlipClassification", "SlipClassification")
                        .WithMany()
